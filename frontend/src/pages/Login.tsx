    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="card w-full max-w-md p-10">
        <div className="text-center mb-10">
          ...
          <div className="text-sm font-bold text-gray-400 uppercase tracking-widest mt-2">Sign in to your account</div>
        </div>
        <form onSubmit={submit} className="space-y-6">
          ...
          <button type="submit" className="primary-btn w-full justify-center text-base py-4 mt-2">Sign In</button>
        </form>
        <p className="text-center text-gray-500 mt-8 text-sm font-medium">
          Don't have an account? <Link to="/signup" className="text-black font-black hover:underline underline-offset-4">Create one</Link>
        </p>
      </div>
    </div>
  )
