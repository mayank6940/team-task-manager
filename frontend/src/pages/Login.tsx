...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-gray-100/50 blur-[120px]"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-gray-200/30 blur-[120px]"></div>
      ...
      <div className="relative w-full max-w-md z-10">
        <div className="card p-10 bg-white shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100">
          <div className="text-center mb-10">
            ...
            <p className="text-sm font-bold text-gray-400 uppercase tracking-widest mt-3">Sign in to your workspace</p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-6">
            ...
            <button type="submit" className="primary-btn w-full justify-center text-base py-4 shadow-2xl shadow-black/10">Sign In</button>
          </form>
          <p className="text-center text-gray-500 mt-10 text-sm font-medium">
            Don't have an account? <Link to="/signup" className="text-black font-black hover:underline underline-offset-8 transition-all">Create one</Link>
          </p>
        </div>
      </div>
    </div>
